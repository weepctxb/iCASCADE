...
# base2_07022021_2134 used for visualisation in report
G = pickle.load(open('data/combined_network/base/base2_07022021_2134.pkl', "rb"))
...
for i in range(len(G)):
    if i in [5, 15, 25]:  # 1, 10, 20, 30
        ...
        plt.savefig("data/combined_network/base/base2_07022021_2134_"+str(i)+".png")
        # plt.savefig("data/combined_network/base/base2_07022021_2134_"+str(i)+".svg")
        plt.show()
