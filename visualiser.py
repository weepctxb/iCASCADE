...
def visualiser_transport_multiplex():
    ...
    for u, v in transport_multiplex_G.edges():
        folium.PolyLine(locations=[(transport_multiplex_G.nodes[u]["pos"][1], transport_multiplex_G.nodes[u]["pos"][0]),
                                   (
                                   transport_multiplex_G.nodes[v]["pos"][1], transport_multiplex_G.nodes[v]["pos"][0])],
                        popup="ID: " + str(u) + "-" + str(v) +
